...
public class CheatsFragment extends Fragment implements AdapterView.OnItemClickListener {
...
//	
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		((ImageView) activity.findViewById(R.id.bg_imageview)).setImageResource(args.getInt(Keys.BG_RESID));
	...
	public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
		...
		dialogArgs.putString(Keys.DIALOG_TITLE, ((TextView)view.findViewById(R.id.title_text)).getText().toString());
		dialogArgs.putString(Keys.DIALOG_CHEAT, ((TextView)view.findViewById(R.id.cheat_text)).getText().toString());
	...
	private class MyAdapter extends BaseAdapter {
		...
		public MyAdapter(Context context) {
			...
			titles = context.getResources().getStringArray(args.getInt(Keys.TITLES_RESID));
			cheatCodes = context.getResources().getStringArray(args.getInt(Keys.CHEATS_RESID));
